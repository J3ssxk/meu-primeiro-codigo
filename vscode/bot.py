...
user_favorite_color = input("Qual sua cor favorita?: ")
print(f"Nossa, {user_favorite_color} é realmente muito bonita! Você tem um bom gosto")
function = input("No que eu posso te ajudar?: ")